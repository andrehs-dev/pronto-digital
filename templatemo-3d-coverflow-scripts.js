...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "Seu Site",
                description: "Sua pagina, do seu jeito!"
            },
            {
                title: "Curriculo",
                description: "Seu curriculo atualizado!"
            },
            {
                title: "Midia Sociais",
                description: "Arte para seu negocio!"
            },
            {
                title: "Cardapio Digital",
                description: "Cardapio para o seu negocio!"
            },
            {
                title: "Conserto",
                description: "Conserto de erros/bugs para seu sistema!"
            },
            {
                title: "Automações",
                description: "WebScraping e Automações"
            },
            {
                title: "Sua Empresa no Google",
                description: "Seja visto no google e maps!"
            }
        ];
